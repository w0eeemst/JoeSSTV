...
// *********************************************************************//
enum class    RigParamX;
enum class    RigStatusX;
...
// *********************************************************************//
template <typename T>
class IOmniRigX_EventsDispatcher : public IUnknown
{
public:
  HRESULT Fire_VisibleChange(void)
  {
    IOmniRigXEventsDisp dispInvoker;
  ...
  HRESULT Fire_RigTypeChange(long RigNumber)
  {
    ...
    if (cpsl.HasConnectionPoint()) {
      for (int i=0; i<cpsl.GetCount(); i++) {
        _di_IInterface punk;
        if (cpsl.GetSink(i, punk) && (dispInvoker.Bind(punk)==S_OK))
          dispInvoker.RigTypeChange(RigNumber);
      }
    }
    return S_OK;
  }
  ...
  HRESULT Fire_StatusChange(long RigNumber)
  {
    ...
    if (cpsl.HasConnectionPoint()) {
      for (int i=0; i<cpsl.GetCount(); i++) {
        _di_IInterface punk;
        if (cpsl.GetSink(i, punk) && (dispInvoker.Bind(punk)==S_OK))
          dispInvoker.StatusChange(RigNumber);
      }
    }
    return S_OK;
  }
  ...
  HRESULT Fire_ParamsChange(long RigNumber, long Params)
  {
    ...
    if (cpsl.HasConnectionPoint()) {
      for (int i=0; i<cpsl.GetCount(); i++) {
        _di_IInterface punk;
        if (cpsl.GetSink(i, punk) && (dispInvoker.Bind(punk)==S_OK))
          dispInvoker.ParamsChange(RigNumber, Params);
      }
    }
    return S_OK;
  }
  ...
  HRESULT Fire_CustomReply(long RigNumber, VARIANT Command, VARIANT Reply)
  {
    ...
    if (cpsl.HasConnectionPoint()) {
      for (int i=0; i<cpsl.GetCount(); i++) {
        _di_IInterface punk;
        if (cpsl.GetSink(i, punk) && (dispInvoker.Bind(punk)==S_OK))
          dispInvoker.CustomReply(RigNumber, Command, Reply);
      }
    }
    return S_OK;
  }
