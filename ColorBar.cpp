	...
	: TForm(AOwner)
{
	...
	if( MsgEng ){
		...
		RGType->Caption = "Afecta";
		RGType->Items->Strings[0] = "Monotono";
		RGType->Items->Strings[1] = "Bitono";
		RGType->Items->Strings[2] = "Colores";
		RGType->Items->Strings[3] = "Bitmap";
		RGType->Items->Strings[4] = "Sonido";
		CBColVert->Caption = "Gradación vertical";
		LLine->Caption = "Linea";
		SelBtn->Caption = "Componentes";
		BitBtn->Caption = "Bitmap";
		GB2->Caption = "Escala(1-8)";
	}
	pBitmap = NULL;
	pItem = NULL;
}
