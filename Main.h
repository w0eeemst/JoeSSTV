...
__published:	// IDE 管理のコンポーネント
	...
	void __fastcall ConectaOmnirig(void);
	AnsiString __fastcall Frecuencia(long frec);
	void __fastcall DesconectaOmnirig(void);
	void __fastcall ConfiguraOmnirig(void);
	...
	void __fastcall KSS1Click(TObject *Sender);
	void __fastcall KSS2Click(TObject *Sender);
	void __fastcall KSS3Click(TObject *Sender);
	void __fastcall KSS4Click(TObject *Sender);
	...
	void __fastcall SpeedButton5MouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	void __fastcall SpeedButton8MouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	...
	void __fastcall SBPrimClick(TObject *Sender);
	void __fastcall SpeedButton11Click(TObject *Sender);
	int __fastcall porcentaje(int max, int valor);
	void __fastcall NetHTTPClient1RequestCompleted(TObject * const Sender, IHTTPResponse * const AResponse);
	void __fastcall HisCallExit(TObject *Sender);
	void __fastcall NetHTTPClient2RequestCompleted(TObject * const Sender, IHTTPResponse * const AResponse);
...
public:
	...
	AnsiString __fastcall adif(AnsiString tipo, AnsiString dato);
	AnsiString __fastcall Frecuencia_Sola(long frec);
...
public:		// ユーザー宣言
    ...
    AnsiString __fastcall qrzkey(AnsiString datos);
...
private:
	...
	AnsiString __fastcall Banda(long frec);
