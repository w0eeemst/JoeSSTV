	...
	: TForm(AOwner)
{
	...
	if( MsgEng ){
		...
		RGType->Caption = "Fuente";
		RGType->Items->Strings[0] = "Historial";
		RGType->Items->Strings[1] = "Imagen cargada";
		RGType->Items->Strings[2] = "Cubrir";
		CBASize->Caption = "Auto ajustar";
		RGShape->Caption = "Forma";
#if 0
		RGShape->Items->Strings[0] = "Rect·ngulo";
		RGShape->Items->Strings[1] = "Borde 1";
		RGShape->Items->Strings[2] = "Borde 2";
		RGShape->Items->Strings[3] = "Borde 3";
		RGShape->Items->Strings[4] = "Elipse";
		RGShape->Items->Strings[5] = "Poligono";
#endif
		LineBtn->Caption = "Frame";
		L1->Caption = "Recorte";
		L2->Caption = "GuÌa";
		CBSmz->Caption = "Suavizado";
		CBR->Caption = "Actualizar";
		GBT->Caption = "Csuavizado de color";
		L3->Caption = "Umbral";
		CTBtn->Caption = "Rehacer";
		CTRBtn->Caption = "Deshacer";
		ClipBtn->Caption = "Recortar";
	  ...
	  TMouseButton Button, TShiftState Shift, int X, int Y)
{
	...
	else if( RGShape->ItemIndex == 5 ){      // ëΩäpå`çÏê¨ÉÇÅ[Éh
		if( !SBFree->Down ){
	  ...
	  TShiftState Shift, int X, int Y)
{
	...
	if( RGShape->ItemIndex == 5 ){      // ëΩäpå`çÏê¨ÉÇÅ[Éh
		TShiftState sc1, sc2;
		sc1 << ssLeft;
		sc2 << ssLeft;
		sc1 *= Shift;
