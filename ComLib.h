...
*/
#define VERBETA " YONIQ"
#define	VERID	"Ver 1.13"
#define	VERTTL2	"MMSSTV "VERID VERBETA
#define	VERTTL  "MMSSTV Ver 1.13 (C) JE3HHT 2001-2010."
#define	VERTTL3 VERTTL2" (C) EA1IMW 2020."
...
void __fastcall DrawBitmap(TPaintBox *pBox, Graphics::TBitmap *pBitmap, TProgressBar *ProgressBar);
