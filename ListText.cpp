...
{
	LPCSTR	_tt[2][9]={
		{"No","Cerco", "Sombra1", "Sombra2", "Sombra3", "Sombra4", "Sombra5", "Sombra6", "?",},
...
//			strcpy(bf, "-");
		...
		LPCSTR	_tt[2][6]={
			{"No.","Texto definido", "Macro conversion", "Tamaño", "Color", "Sombra",},
