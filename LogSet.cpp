	...
	: TForm(AOwner)
{
	...
	if( MsgEng ){
		TabConv->Caption = "Conversi";
		TabMisc->Caption = "Misc";
		CancelBtn->Caption = "Cancelar";
		Caption = "Configurar registro";
		TabFlag->Caption = "Entrada";
		GrpConv->Caption = "Convertir May俍culas";
		GrpCopy->Caption = "Copiar Antes de Datos";
		CopyFreq->Caption = "Copiar Banda o Freq.";
		CopyFreq->Items->Strings[0] = "Copiar Banda";
		CopyFreq->Items->Strings[1] = "Copiar Freq.";
		DefMyRST->Caption = "595 defecto";

		RGDupe->Caption = "Duplicados (En Rojo)";
		RGDupe->Items->Strings[0] = "Solo indicativo";
		RGDupe->Items->Strings[1] = "En la misma banda";
		AutoZone->Caption = "Ignorar horario verano";
		CBBackup->Caption = "Hacer una copia de seguridad";
		CBFSKNR->Caption = "Agregar concurso NR al FSKID";
		CBRemC->Visible = FALSE;
		L1->Caption = "Tiempo de retardo";
		GB7->Caption = "Model";
        GB9->Caption = "Modo";
	}
	else {
